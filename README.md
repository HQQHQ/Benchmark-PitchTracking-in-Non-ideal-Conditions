...
- **Basic Pitch:** Overall most stable, with strong resistance to distortion, 
noise, and pitch deviation.  
- **CREPE:** Performs best with clean audio but is extremely sensitive to various interferences.  
- **Librosa:** Lower accuracy but stable performance, less affected by interference.  
